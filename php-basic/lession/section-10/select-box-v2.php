    ...
    <div class="col-md-6">
        ...
        <form action="" method="POST">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="username" id="user_name" value="<?php
            ...
            <div class="form-group">
                <label class="" for="payment_method">
                    Chọn phương thức thanh toán
                </label>
                <select class="form-control" name="payment-method" id="payment_method">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="option-only-one" id="exampleFormControlSelect1">
                    <option>1</option>
                    <option>2</option>
                    <option>3</option>
                    <option>4</option>
            ...
            <div class="form-group">
                ...
                <select multiple class="form-control" name="option-multiple" id="exampleFormControlSelect2">
                    <option>1</option>
                    <option>2</option>
                    <option>3</option>
                    <option>4</option>
