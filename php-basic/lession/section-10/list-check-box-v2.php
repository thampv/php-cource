...
<?php
    $site_title = "List check box in Php";
            ...
            <form acton="" method="POST">
                <div class="col-md-12">
                    ...
                    <div class="form-check mt-3">
                        <input class="form-check-input" type="checkbox" name="cat[]" id="cat_1"
                            value="Thời sự">
                    ...
                    <div class="form-check mt-0">
                        <input class="form-check-input" type="checkbox" name="cat[]" id="cat_2"
                            value="Góc nhìn">
                    ...
                    <div class="form-check mt-0">
                        <input class="form-check-input" type="checkbox" name="cat[]" id="cat_3"
                            value="Thế giới">
                    ...
                    <div class="form-check mt-0">
                        <input class="form-check-input" type="checkbox" name="cat[]" id="cat_4"
                            value="Video">
                    ...
                    <div class="form-check mt-0">
                        <input class="form-check-input" type="checkbox" name="cat[]" id="cat_5"
                            value="Podcasts">
                    ...
                    <div class="form-check mt-0">
                        <input class="form-check-input" type="checkbox" name="cat[]" id="cat_6"
                            value="Kinh doanh">
                    ...
                    <div class="form-check mt-0">
                        <input class="form-check-input" type="checkbox" name="cat[]" id="cat_7"
                            value="Khoa học">
                ...
                <div class="col-md-12 mt-3">
                    <button type="submit" class="btn btn-primary btn-block" name="add-post" value="Add post">Thêm bài viết</button>
                </div>
            </form>
        </div>
    </div>
