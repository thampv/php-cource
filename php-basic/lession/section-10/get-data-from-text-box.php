...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h1 class="text-primary">Get data form text box</h1>
            <form action="" method="POST">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12 mt-1">
                            <button name="login" class="btn btn-primary btn-block" type="submit" value="login"">Login</button>
                        </div>
                    </div>
                </div>
            ...
            <?php
                ...
                if(isset($_POST['login'])){
                    if(empty($_POST['username'])){
                        ...
                        echo "Username của người dùng là: " . $_POST['username'];
                        echo "<br>";
                        echo "Password của người dùng là: {$_POST['password']}";
                    }
                }
