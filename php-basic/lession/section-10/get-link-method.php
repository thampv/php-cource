            ...
            <h1 class='text-primary'>Get Method In Php - Phương thức Get trong Php</h1>
                <div class='form-row'>
                    <div class='col-md-8'>
                        <br>
                        <br>
                        <a href='?product=iphone7plus&price=4tr&id=123456'>Sản phẩm</a>
                    </div>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <?php
                echo "<br>";
                echo "Thông tin product trong link là: {$_GET['product']}";
                echo "<br>";
                echo "Thông tin price trong link url Sản phẩm là: ".$_GET['price'];
                echo "<br>";
                echo "Thông tin id trong link url Sản phẩm là: {$_GET['id']}";
            ?>
        </div>
    </div>
</div>
