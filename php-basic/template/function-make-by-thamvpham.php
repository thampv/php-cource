...
<?php
    // echo create_input_text_bootstrap("username_id", "Username", "username", "text", $class_label = array('bg-light', 'text-primary','font-weight-bold'), $class_input = array('','',''));
...
<!-- FUNCTION MAKE BY THAMVPHAM -->

<?php

//=================================================================
// LIST FUNCTION MAKE BY THAMVPHAM - DANH SÁCH HÀM TỰ PHÁT TRIỂN
//=================================================================
...
# 4. html_end ==> write close html tag - viết thẻ đóng html </htm>
...
# example:
    //=================================================
    /* create_input_text_bootstrap("username_id", "Username", "username", "text", $class_label = array('bg-light', 'text-primary','font-weight-bold'), $class_input = array('','','')) */
    //=================================================
...
# example:
    //=================================================
    /* create_button_bootstrap("btn-sign-up", "Đăng ký", "sign-up", $button_class = array('btn-primary', '', '')) */
    //=================================================
    ...
    function create_button_bootstrap(){
        ...
        <button name='{$button_name}' value='{$button_value}' class='btn {$button_class[0]} {$button_class[1]} {$button_class[2]}'>{$button_label}</button>
